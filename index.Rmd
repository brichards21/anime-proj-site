...
E[Score] = -14.4 + 0.0004Episodes + 0.16Rating_{PG-13} + 0.05Rating_{PG} + 0.22Rating_{R} - 0.16Rating_{R+} - 0.21Rating_{Rx} + 0.000001Members + 0.02Duration + 0.02Action + 0.15Comedy + 0.31Drama + 0.26Historical + 0.06Magic + 0.04School + 0.28Shounen + 0.23Slice of Life + 0.01Start Year + 0.03Num. Years Running
